...
图 14.3 说明了主要会议的财务实力。平均而言，在 2014 财年 Power 5 会议上，NCAA 的收入为 3790 万美元，范围在 3170 万美元至 4870 万美元之间。剩下的五个 I-FBS 部门会议，即 5 国集团会议（美国运动，C-USA，MAC，Sunbelt 和 Mountain West），平均获得 2240 万美元，其范围在 1160 万美元至 4470 万美元之间。非 FBS 会议的平均收入为 880 万美元，从 500 万美元到 1,870 万美元不等。季后碗比赛和会议电视网络的收入进一步加强了主要会议的财务状况。
...
通过查看会议税申报表（表格 990 –免征所得税的组织退还），我们可以进一步检查 I 部门会议收入之间的差异。首先，我们必须注意到很难直接比较两个类似组织在大学体育方面的比较，因为没有报告财务状况的标准。图 14.4 至图 14.6 确实提供了比较的基础。图 14.4 给出了 SEC 和 Big XII 这两个主要会议的 2013 年收入和支出。从会议的纳税申报表中，我们可以看到 Big XII 报告的收入比 SEC 更为详细，尽管我们可以直接比较媒体版权和季后活动的收入。Big XII 的媒体版权收入比 SEC 低 7060 万美元。与碗状游戏，NCAA 和门票销售收入相比，它的收入也比 SEC 低 1240 万美元（SEC 将这些收入归为“季后赛”）。显然，SEC 的财务状况更强，因为会议的收入比 Big XII 多了 9810 万美元。
...
【】展览 14.3 NCAA 的 2014 年 I 类收入分配计划【】展览 14.4 2013 年两次 I-FBS Power 5 会议的收入和支出。
...
1984 年之前，NCAA 控制着大学橄榄球的电视转播权。那一年，乔治亚大学和俄克拉荷马大学起诉 NCAA，声称 NCAA 对广播的控制违反了《谢尔曼法》。美国最高法院同意 NCAA 的行为违反了该法第 1 节（NCAA 诉摄政委员会，1984 年）。裁定后，大多数主要的足球会议和独立足球运动员（宾州州立大学和巴黎圣母院）一起加入了大学橄榄球协会（CFA），为成员们谈判集体电视节目。Pac 10 和 Big 10 谈判了自己的电视合同。到 1991 年，宾夕法尼亚州立大学和巴黎圣母院已离开终审法院，以便自行进行谈判。1995 年 SEC 离开后，CFA 解散，以寻求通过与 CBS 签订独家合同来增加收入的机会。（CBS 刚刚将其 NFL 电视节目包丢失给了 Fox。）在签署电视合同之后，SEC 向会员学校的总付款从 4550 万美元增加到 5890 万美元。2008 年，美国证券交易委员会（SEC）考虑通过推出自己的电视网络来遵循“十大”模式。但是，联盟选择与 CBS 和 ESPN 签署协议。与 ESPN 和 CBS 的合作伙伴关系每年为联盟带来了 2.05 亿美元的媒体版权收入（Smith＆Ourand，2008 年）。
...
十大巨头与合作伙伴新闻集团（News Corp）于 2007 年建立了自己的网络。大会在该网络中拥有 51％的所有权，从而在 2007 财年带来了 6,600 万美元的新收入。在协议有效期内，十大巨头的平均年收入为 1.12 亿美元，支付给会议的费用预计将在交易期限内增加。在十大巨头启动网络的同时，它与 ABC / ESPN 签订了为期十年，价值 10 亿美元的国家版权合同。十大巨头在协议的第一年（2008 年）获得了 8,300 万美元，版权费用预计将在合同有效期内增加。这些电视协议的结果是，在 2006 年至 2008 年之间，十大巨头的总收入增长了 39.8％，分配给会员学校的收入增长了 30.9％（Broughton，2008 年）。尽管与新闻集团建立十大网络（BTN）的合作关系持续到 2032 年，但其与 ABC / ESPN 和 CBS 的足球和篮球协议在 2017 赛季后到期（Sherman，2015 年）。预计新的电视转播权协议将使 10 大学校每年获得超过 4,500 万美元的收入。联盟学校预计在 2014 年各赚取约 2100 万美元（Fornelli，2014 年）。
...
SEC Network 是与 ESPN 合作创建的，其源于 2008 年与该网络的媒体版权交易。ESPN 拥有的 SEC Network 紧随 Big 10 的领导并加入拥有自己的品牌网络的 Pac 12 会议之后，于 2014 年启动，并将在 2034 年之前为该会议创收。
在网络运营的第一年结束时，SEC 创造了创纪录的 4.558 亿美元收入（McMurphy）。
...
正如十大巨头和 SEC 所说明的那样，会议的收益能力对其成员学校具有积极影响。会议的大部分收入都分配给了其成员学校（参见图 14.4）。在 SEC 中，支付给会员学校的费用从 2090 万美元到 2150 万美元不等。尽管 Big XII 在 2013 年的总收入大会上的收入较少，但其会员学校的收入与 SEC 的收入相当，但 Big XII 的两个新会员学校 TCU 和西弗吉尼亚州除外。作为参加会议的协议的一部分，学校在会议的头几年减少了分配。

#### Division I–FBS, Group of 5 conferences I－FBS 部门，共 5 个会议
...
图表 14.5 重点介绍了 I-FBS 的两个 I 区会议（共 5 个会议）的收入和支出：C-USA 和 Mountain Western 会议（MWC）。通过比较图表 14.4 和 14.5 中的会议收入，我们可以看到媒体权利在产生会议收入中的重要性。这四个会议都在同一级别竞争，但是没有自己的网络或大型媒体权利协议来播放足球，篮球和其他体育节目，会影响整个会议的收入，进而影响成员学校的收入。C-USA 的电视和营销收入为 1,040 万美元，MWC 的媒体收入为零，而 SEC 的收入为 2.104 亿美元，Big XII 的收入为 1.297 亿美元。这些数字清楚地表明，通过媒体版权交易来利用游戏（主要是足球和篮球比赛）对于产生会议收入至关重要。
...
图表 14.5 还说明了在会议中拥有 12 个团队的好处。拥有 12 个团队的会议可以根据 NCAA 规则参加足球会议冠军赛。C-USA 和 MWC 各自有 12 名足球运动员。MWC 在其联邦文件中清楚地表明了其会议足球锦标赛的收入，2013 年为 170 万美元。此外，我们可以看到高质量篮球计划的重要性。在没有保证每年参加大学橄榄球季后赛比赛或没有与大学橄榄球季后赛相关联的赛事中，会议必须依靠内华达大学 - 拉斯维加斯（UNLV）等学校的团队在 NCAA 男子篮球冠军赛中创收。C-USA 是 2013 年更强大的篮球会议，其篮球收入比 MWC（360 万美元）多得多。在 C-USA 比赛中表现更好的篮球，再加上其 12 个赞助足球的会员机构，大大提高了会议的收入。2013 年，C-USA 获得了 1,040 万美元的电视收入，仅比 MWC 的总收入少了 270 万美元，尽管这只是 Big XII 获得的 1.379 亿美元电视收入中的一小部分。
...
图 14.5 揭示了会议举办冠军足球赛的另一影响。当 ACC 在 2004 年从 9 个成员机构扩展到 12 个成员时，包括 C-USA 在内的多个 I 类会议发生了变化。陆军独立后，总共有 23 个团队更改了会议。
这些变化造成了更多的涟漪，而在撰写本文时，学校的隶属关系也在不断变化。
由于这些转变，C-USA 正在向数位前会议成员以及现任成员付款（参见图 14.5）。
...
图表 14.6 列出了 Atlantic 10（A10）会议的收入和支出。如图 14.6 所示，A10 的学校是 I-FCS 部门的成员，会议的主要收入来源与篮球有关。这次会议从 NCAA 收到了 1,430 万美元，用于参加男子篮球锦标赛，比 C-USA 或 MWC 都多。由于与 I-FBS 分区会议中的学校相比，A10 几乎没有足球收入，因此分配给 A10 成员学校的资金远远少于分配给 I-FBS 成员学校的资金。A10 仅列出其会员的总分配额 -2013 财年为 1,090 万美元。2013 年有 16 个成员机构，平均每个机构 683,000 美元。
